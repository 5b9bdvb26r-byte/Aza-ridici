        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="flex items-center gap-6 mt-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-green-700 font-medium">{available.length} dostupných</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-4 h-4 bg-orange-500 rounded-full" />
              <span className="text-orange-700 font-medium">{partial.length} částečně</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-4 h-4 bg-red-500 rounded-full" />
              <span className="text-red-700 font-medium">{unavailable.length} nedostupných</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Klikněte na tlačítko pro změnu stavu. Dlouhým kliknutím můžete přidat poznámku.
            </p>
                ...
                >
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      className="w-10 h-10 rounded-lg flex items-center justify-center text-lg bg-blue-100 text-blue-600 hover:bg-blue-200 transition-all"
